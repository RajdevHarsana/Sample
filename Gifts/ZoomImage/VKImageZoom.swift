...
class VKImageZoom: UIViewController {
    ...
    private func addView_components() -> Void {
        ...
        img_scroll?.frame = CGRect.init(x: 0, y: 0, width: img_width, height: (img_height-6*status_height))
        ...
        zoom_imgView?.frame = CGRect.init(x: 0, y: 0, width: img_width, height: 800)
        ...
        cancel_btn?.frame = CGRect.init(x: (img_width-36), y: (status_height-10), width: 30, height: 30)
