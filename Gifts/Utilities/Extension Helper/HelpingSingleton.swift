...
struct Helper {
    ...
    func isEmailOrPhoneNumberInField(email: String) -> String{
        do {
           let detector = try NSDataDetector(types: NSTextCheckingResult.CheckingType.phoneNumber.rawValue)
           let numberOfMatches = detector.numberOfMatches(in: email, range: NSRange(email.startIndex..., in: email))
