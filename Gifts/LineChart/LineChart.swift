...
//                    var touchLocation = lineChart.convert(recognizer.location(in: self), to: lineChart.datasets.first)
//                    if let point = lineChart.closestPointTo(refPoint: touchLocation) {
...
//                            let rect = CGRect(origin: lineChart.convert(point.position, from: lineChart.datasets.first), size: CGSize(width: 1.0, height: 1.0))
//                            popoverController!.present(from: rect, in: self, permittedArrowDirections: UIPopoverArrowDirection.any, animated: false)
//                        }
//                    }
...
//            return formatter.stringFromNumber(NSNumber(self / 1000))! + "k"
//        } else if exponent >= 6 && exponent < 9 && self % 100000 == 0 {
//            formatter.maximumSignificantDigits = 3
//            return formatter.stringFromNumber(NSNumber(self / 1000000))! + "M"
//        }
...
//                CGPathMoveToPoint(path, point.x, point.y)
//            } else {
//                CGPathAddLineToPoint(path, point.x, point.y)
//            }
//        }
//        return path
//    }
...
//            var controlPoints = controlPoints(t: prevPoint, i: point, e: nextPoint, s: pTension)
//
...
//                    //layerFont = UIFont(name: fontName, size: fontSize)
//                    layerFont = CTFontCreateWithName(fontName, fontSize, nil);
//                } else if ftypeid == CGFont.typeID {
//                    let fontName = (font as! CGFont).postScriptName
//                    //layerFont = UIFont(name: fontName, size: fontSize)
//                    layerFont = CTFontCreateWithName(fontName!, fontSize, nil);
//                }
//            }
...
//    func sizeToFit() {
//        #if os(iOS)
//        bounds = CGRect(origin: .zero, size: self.attributedString.size())
//        #else
